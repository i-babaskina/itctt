...
namespace WebApplicationTest.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        public ActionResult LoginMy(String returnUrl)
        {
        ...
        public ActionResult Logout()
        {
            ...
            return RedirectToAction("LoginMy");
        }

        //[HttpPost]
        //[AllowAnonymous]
        //[ValidateAntiForgeryToken]
        //public async Task<ActionResult> LoginMy(LoginMyViewModel model, String returnUrl)
        //{
